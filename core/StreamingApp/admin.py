...
from .models import Producer, Series, SeriesGenre, Genre, User, WatchHistory, Episode, SpotLightSeries, Watchlist, Comment
...
class CommentAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'content', 'created_at', 'comment_id')